...
class AirPollutionCollectionViewCell: UICollectionViewCell {
    ...
    private func setConstraint() {
        ...
        qualityIndex.leftAnchor.constraint(equalTo: iconQualityIndex.rightAnchor, constant: 5).isActive = true
...
extension AirPollutionCollectionViewCell {
    ...
    public func configureAirPollution(array: ListAir) {
        self.airPollution = array
